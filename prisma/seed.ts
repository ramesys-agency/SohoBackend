...
async function main() {
    ...
    const collectionData = [
        { name: "Men's Grand Summer Sale", slug: "men-top-banner", gender: { set: ["MEN" as const] } },
        { name: "Women's Trending Collection", slug: "women-top-banner", gender: { set: ["WOMEN" as const] } },
        { name: "Kids New Arrivals", slug: "kids-top-banner", gender: { set: ["KIDS" as const] } },
        { name: "Home Top Offer", slug: "home-top-banner", gender: { set: ["MEN" as const, "WOMEN" as const, "KIDS" as const] } },
        { name: "New Arrivals", slug: "new-arrivals", gender: { set: ["MEN" as const, "WOMEN" as const] } },
    ];
